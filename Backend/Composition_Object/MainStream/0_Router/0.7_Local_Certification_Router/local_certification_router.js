...
this.Pure_Router.post('/',async (req,res)=>{   
   ...
   switch(condition){
      ...
      const rejected_session = await fetch('http://localhost:8080/loginrejected/sessionset',{
         method: 'PATCH'
      })
      ...
      const approved_session = await fetch('http://localhost:8080/locallogin/sessionset',{
         method: 'PATCH'
      })
